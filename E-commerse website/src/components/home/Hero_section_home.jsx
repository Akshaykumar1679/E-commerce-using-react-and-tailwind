...
function Hero_section_home() {
  return (
    ...
    <div className=" md:ml-16 ml-3">
        ...
        <button className=" my-4 w-full  font-bold text-lg bg-[url('./asset/homeimage/button.png')] bg-no-repeat bg-[top_right_10rem]  text-[#088178] px-3 py-1 ">Shop now</button>
    </div>
</div></div>
  )
}
